...
public class Wouldlie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wouldlie);
            ...
            public void onClick(View view) {
                if(mAnswer == true) {
                    ...
                    if (mQuestionNumber == QuizBook.questions.length) {
                        Intent i = new Intent(Wouldlie.this, ResultActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putInt("finalScore", mScore);
                        i.putExtras(bundle);
                        Wouldlie.this.finish();
                        startActivity(i);
                    } else {
                        updateQuestion();
                    }
    ...
    private void askToClose (){
        AlertDialog.Builder builder = new AlertDialog.Builder(Wouldlie.this);
